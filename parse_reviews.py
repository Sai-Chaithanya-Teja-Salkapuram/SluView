...
# 1. Load the HTML you saved with curl
with open("listing.html", "r", encoding="utf-8") as f:
    html = f.read()

soup = BeautifulSoup(html, "lxml")

# 2. Extract top-level info (business name, total reviews count)
...
print(f"✅ Extracted {len(all_reviews)} reviews into data.json and data.csv")
